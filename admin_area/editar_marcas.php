...
if(!isset($_SESSION['admin_email']) && (!isset($_SESSION['admin_pass']))){
    ...
    if(isset($_GET['editar_marcas'])){
        ...
        $edit_p_cat_id = $_GET['editar_marcas'];

        $edit_p_cat_query = "select * from product_marcas where p_cat_id='$edit_p_cat_id'";
        ...
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            ...
            <ol class="breadcrumb"><!-- breadcrumb Starts -->
                ...
                <li>
                    ...
                    <i class="fa fa-dashboard"></i> Dashboard / Editar Marca
    ...
    if(isset($_POST['update'])){
        ...
        $update_p_cat = "update product_marcas set p_cat_title='$p_cat_title' where p_cat_id='$p_cat_id'";

        $run_p_cat = mysqli_query($con,$update_p_cat);

        if($run_p_cat){

            echo "<script>alert('Marca Alterada')</script>";
